...
;; (setq! python-pytest-executable "/home/light/.virtualenvs/ezbetgames/bin/python -m pytest")
;; (setq! python-pytest-executable "docker-compose -f local.yml run --rm django pytest")
#+END_SRC
